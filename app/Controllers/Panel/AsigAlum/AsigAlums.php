...
class AsigAlums extends BaseController {

    private $view = 'panel\asigalum\asigalums';
    ...
    private function cargar_datos(){
        ...
        $datos['nombre_pagina'] = 'Asignación de alumnos | Admin';
        $datos['titulo_pagina'] = 'Asignación de alumnos ';
