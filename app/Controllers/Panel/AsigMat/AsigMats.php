...
class AsigMats extends BaseController {

    private $view = 'panel\asigmat\asigmats';
    ...
    private function cargar_datos(){
        ...
        $datos['nombre_pagina'] = 'Asignación de materias | Admin';
        $datos['titulo_pagina'] = 'Asignación de materias';
