...
<div class="content">
    ...
    <div class="card">
              ...
              <div class="col-sm-12 text-left">
                <a class="btn btn-success" href="<?= route_to('nuevo_materia')?>" >Registrar Materias</a>
                <table id="dataTable" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  style="">creditos</th>
                  ...
                  <?php 
                    ...
                    if(sizeof($asignaturas) > 0){
                      foreach($asignaturas as $asignatura){
                        ...
                        <td style="">'.$asignatura->asignatura.'</td>
                        <td style="">'.$asignatura->acronimo.'</td>
                        <td style="">'.$asignatura->creditos.'</td>
                        <td style="">
                        <a class="btn btn-primary"   href="'.route_to("detalles_materia",$asignatura->idasignatura).'">Detalles</a>
                        <a class="btn btn-danger" href="'.route_to("eliminar_materia",$asignatura->idasignatura).'">Eliminar</a>
                        </td>
                      </tr>
                      ';
                      }
                  ...
                  <th rowspan="1" colspan="1" style="">creditos</th>
