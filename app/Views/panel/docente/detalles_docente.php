...
<div class="content">
    <div class="container-fluid">
        <div class="card card-success">
            ...
            <div class="card-body">
            <?= form_open("actualizar_docente/".$docente->iddocente, ["id" => "form-nuevo-docente"]) ?>
                    <div class="row">
                        ...
                        <label for="usuario">Seleccionar usuario</label><font color="red">*</font>
                            ...
                            echo form_dropdown('usuario', $options,$docente->usuario_idusuario, 'class="form-control" id="usuario" required');
                            ?>
                        ...
                        echo form_dropdown('programa', $options, $docente->programa_educativo_idpe, 'class="form-control" id="programa" required');
                        ?>
