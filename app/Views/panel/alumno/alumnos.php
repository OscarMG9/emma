                      ...
                      foreach($listas as $lista){
                        ...
                        <td style="">';                   
                          ...
                          foreach($materias as $materia){
                            ...
                            $html.='</td>
                            <td style="">'.$lista->fecha_registro.'</td>
                            <td style="" class="text-center">';
                            if ($lista->estatus_alumno == ESTATUS_REGULAR){
                              $html.= '<a class="btn btn-success">Regular</a>';
                            }elseif ($lista->estatus_alumno == ESTATUS_IRREGULAR) {
                              $html.= '<a class="btn btn-danger">Irregular</a>';
                            }elseif($lista->estatus_alumno == ESTATUS_INACTIVO){
                              $html.= '<a class="btn btn-dark">Inactivo</a>';
                            }
                            $html.='
                      </td>
                        <td style="">
                        <a class="btn btn-primary" href="'.route_to("detalles_alumno",$lista->idlista_alumnos).'">Cambiar estatus</a>
                        </td> 
                      </tr>
                      ';
                    }
